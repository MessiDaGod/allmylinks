...
import DataGrid, {Column, Direction, SelectCellFormatter, SelectColumn, SortColumn, TextEditor} from 'react-data-grid';
...
function exportToCsv(gridElement: JSX.Element, arg1: string): Promise<unknown> {
    throw new Error('Function not implemented.');
}

function exportToXlsx(gridElement: JSX.Element, arg1: string): Promise<unknown> {
    throw new Error('Function not implemented.');
}

function exportToPdf(gridElement: JSX.Element, arg1: string): Promise<unknown> {
    throw new Error('Function not implemented.');
}

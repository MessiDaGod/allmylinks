...
var JsFormattingEngine = function() {
    ...
    var _WorkerService = function() {
        ...
        var RequestFormatting = function(initializationData) {
            worker.postMessage({
                commandToRun: "format",
                paramLength: initializationData.paramLength,
                options: initializationData.options,
                inputSql: initializationData.inputSql
            });
        }
...
*/
        ...
        effectiveService.RequestFormatting({
            paramLength: parameterString.length,
            options: parsedParams,
            inputSql: parsedParams.inputString
        });
    }
